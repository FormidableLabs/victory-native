...
export default {
  onTouchStart: BrushHelpers.onMouseDown.bind(BrushHelpers),
  onTouchMove: throttle(BrushHelpers.onMouseMove.bind(BrushHelpers), 16, {leading: true}),
  onTouchEnd: BrushHelpers.onMouseUp.bind(BrushHelpers)
};
