...
const Helpers = {
  ...VictoryBrushHelpers,
  onTouchStart(evt, targetProps) { // eslint-disable-line max-statements
    const {
  ...
  onTouchMove(evt, targetProps) { // eslint-disable-line max-statements, consistent-return
