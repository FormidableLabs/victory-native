...
import { Data, Selection, Helpers } from "victory-core/src";
...
export default {
  onTouchEnd: NativeHelpers.onTouchEnd.bind(NativeHelpers),
  onTouchMove: throttle(NativeHelpers.onTouchMove.bind(NativeHelpers), 16, {leading: true})
};
