...
export default {
  onTouchStart: SelectionHelpers.onMouseDown.bind(SelectionHelpers),
  onTouchMove: throttle(SelectionHelpers.onMouseMove.bind(SelectionHelpers), 16, {leading: true}),
  onTouchEnd: SelectionHelpers.onMouseUp.bind(SelectionHelpers)
};
